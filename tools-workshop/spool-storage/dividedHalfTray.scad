    ...
    translate([0, 0, .01]) difference() {
      intersection() {
        difference() {
          ...
          rotate([0, 0, -22.5]) cube([wallThickness, outerRad * 2, height * 2 + 2], center = true);
          rotate([0, 0, -45]) cube([wallThickness, outerRad * 2, height * 2 + 2], center = true);
          rotate([0, 0, -67.5]) cube([wallThickness, outerRad * 2, height * 2 + 2], center = true);
        }
