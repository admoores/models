...
difference() {
  ...
  union() {
    ...
    translate([totalWidth - wallThickness - holderWidth / 2, holderLen / 3 + wallThickness, -(holderWidth / 2) - (holderBaseLen / 2 * sin(45))]) rotate([45, 0, 0]) cylinder(r = holderBaseWidth / 2, h = holderBaseLen * 2, center=true);
    ...
    translate([totalWidth - wallThickness - powerBrickSide, -.01, -totalHeight + wallThickness]) cube([powerBrickSide, powerBrickLen + .01, powerBrickSide]); 
